...
st.markdown('''
 Este dashboard foi elaborado durante meu período no Departamento de Transformação e Tecnologia Mineral do Ministério de
...
(Pró-Minerais Estratégicos) e o Comitê Interministerial de Análise de Projetos de Minerais Estratégicos (CTAPME). \n
 A ferramenta permite acessar informações acerca dos projetos de mineração habilitados na política. Os usuários podem investigar dados dos empreendimentos, incluindo investimento, títulos minerários, produção, reservas, recursos e informações gerais sobre o licenciamento ambiental. \n
